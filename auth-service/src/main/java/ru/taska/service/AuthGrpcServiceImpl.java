...
@Slf4j
public class AuthGrpcServiceImpl extends AuthServiceGrpc.AuthServiceImplBase implements AuthGrpcService{
    ...
    public void login(LoginRequest request,
        ...
        authServiceImpl.login(request.getEmail(), request.getPassword())
                .subscribe(
                        response -> {
    ...
    public void refresh(RefreshRequest request,
        ...
        authServiceImpl.refresh(request.getRefreshToken())
                .subscribe(
                        response -> {
