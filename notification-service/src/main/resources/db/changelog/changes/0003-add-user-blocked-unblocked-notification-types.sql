...
-- changeset taska:0003-add-user-blocked-unblocked-notification-types
-- comment: Добавление типов уведомлений для блокировки/разблокировки пользователя (USER_BLOCKED, USER_UNBLOCKED)
