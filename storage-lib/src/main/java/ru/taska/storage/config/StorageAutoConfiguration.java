...
public class StorageAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public StorageClient storageClient(S3Client s3Client, S3Presigner s3Presigner, StorageProperties properties) {
        return new MinioStorageClient(s3Client, s3Presigner, properties);
    }
}
